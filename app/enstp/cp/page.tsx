...
export default function ENSTPCPPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0A1D37] text-white" dir={dir}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <h2 className="text-2xl font-bold text-center text-[#F57C00] mb-8">Cycle Préparatoire (CP)</h2>
        ...
        >
          <Card className="bg-[#0A1D37]/80 border-[#F57C00] border-2">
            <CardContent className="p-8 flex flex-col items-center text-center">
              <Clock className="h-16 w-16 text-[#F57C00] mb-4" />
              <h3 className="text-xl font-bold text-white mb-4">
                Modules du Cycle Préparatoire en cours d'intégration
              </h3>
              <p className="text-white/70 max-w-lg">
                Les modules et ressources pédagogiques pour le cycle préparatoire seront bientôt disponibles. Nos
                équipes travaillent actuellement à leur développement pour vous offrir une expérience d'apprentissage
                optimale.
              </p>
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-md">
                <div className="bg-white/10 p-4 rounded-md">
                  <h4 className="font-medium text-white">Mathématiques</h4>
                  <p className="text-white/60 text-sm mt-1">Prochainement disponible</p>
                </div>
                <div className="bg-white/10 p-4 rounded-md">
                  <h4 className="font-medium text-white">Physique</h4>
                  <p className="text-white/60 text-sm mt-1">Prochainement disponible</p>
                </div>
                <div className="bg-white/10 p-4 rounded-md">
                  <h4 className="font-medium text-white">Chimie</h4>
                  <p className="text-white/60 text-sm mt-1">Prochainement disponible</p>
                </div>
                <div className="bg-white/10 p-4 rounded-md">
                  <h4 className="font-medium text-white">Informatique</h4>
                  <p className="text-white/60 text-sm mt-1">Prochainement disponible</p>
                </div>
              </div>
            </CardContent>
